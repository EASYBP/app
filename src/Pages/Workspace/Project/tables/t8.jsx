...
const T8 = () => {
  const data = useSelector((state) => state.project.t8).map((d) =>
  ...
  const getControle = (e1, e2) =>
    ...
    getVal({
      item: dataT8[dataT8.findIndex((d) => d.i === e2)],
      data,
      list: dataT8,
      bs,
    });
  ...
  return (
    <MyMaterial
      title="Répartition ECP issus du Bilan d'ouverture préliminaire 1"
      data={DataTable({
        data,
        list: dataT8,
        bs,
...
export const dataT8 = [
  {
    i: 1,
    p: 1,
    title: "ECA-2710 Diminution des créances immobilisées",
    bs: 49,
  },
  ...
  { i: 11, space: true, special: "space" },
  {
    i: 12,
    p: 1,
    title: "ECA-2720 Augmentation des dettes de financement",
    bs: 50,
  },
