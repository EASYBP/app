...
const T11 = () => {
  const data = useSelector((state) => state.project.t11).map((d) =>
  ...
  const getControle = (e1, e2) =>
    ...
    getVal({
      item: dataT11[dataT11.findIndex((d) => d.i === e2)],
      data,
      list: dataT11,
      bs,
    });
  ...
  return (
    <MyMaterial
      title="Répartition ECA circulant Bilan d'ouverture préliminaire 2"
      data={DataTable({
        data,
        list: dataT11,
        bs,
...
export const dataT11 = [
  {
    i: 1,
    p: 1,

    title: "ECP-4701 Augmentation des créances circulantes",
    bs: 114,
  },
  ...
  { i: 48, space: true, special: "space" },
  {
    i: 49,
    p: 1,
    title: "ECP-4702 Diminution des dettes circulantes",
    bs: 115,
  },
...

  {
    ...
    relation: [
      ...
      69, 70, 71, 72, 73, 74, 75, 76, 77, 780, 78, 79, 80, 81, 82, 83, 84, 85,
      86, 87,
    ],
  },
